...
class FastRCNNOutputLayersWithoutClassifier(nn.Module):
    """
...
class StandardROIHeadsWithoutClassifier(StandardROIHeads):
  def __init__(self, cfg, input_shape):
    super().__init__(
                        cfg, 
                        input_shape,
                        box_predictor=FastRCNNOutputLayersWithoutClassifier(cfg, input_shape)
                    )